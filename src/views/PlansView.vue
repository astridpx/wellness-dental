...
<template>
    ...
    <template #dialog-content>
      <div class="space-y-5">
        ...
        <div class="grid gap-5">
          <AppInput v-model="draftFilters.planTypeId" label="Plan Type ID" placeholder="e.g. 951" icon="feather:hash" />
          <AppInput v-model="draftFilters.planCode" label="Plan Code" placeholder="e.g. XNT003" icon="feather:tag" />
          <AppInput v-model="draftFilters.dentalPremium" label="Dental Premium 1" placeholder="e.g. 8"
  ...
  <div class="space-y-6">
    <section
      ...
      <div class="grid gap-px border-t border-pebble bg-pebble sm:grid-cols-2">
        <div class="bg-white px-6 py-5">
          ...
          <p class="mt-2 text-3xl font-black text-onyx">{{ plans.length }}</p>
        </div>
        <div class="bg-white px-6 py-5">
          ...
          <div class="mt-2 flex items-center gap-2 text-sm font-semibold text-onyx">
            <span class="h-2.5 w-2.5 rounded-full bg-emerald" />
    ...
    <section class="rounded-[1.5rem] border border-pebble bg-white p-5 shadow-sm sm:p-6">
      ...
      <AppLoadingScreen v-if="loadingPlans" title="Loading plans"
      ...
      <div v-else class="overflow-hidden rounded-[1.5rem] border border-pebble">
        <AppTable :theads="['Plan Type ID', 'Plan Code', 'Dental Premium 1']" :total-entries="filteredPlans.length"
